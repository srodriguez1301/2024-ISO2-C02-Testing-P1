...
public class Principal {
	public static void main(String[] args) {
		...
		Persona persona = new Persona(nombre.isEmpty() ? "No especificado" : nombre,
				apellidos.isEmpty() ? "No especificado" : apellidos, fechaNacimiento,
				nacionalidad.isEmpty() ? "No especificado" : nacionalidad,
				titulacion.isEmpty() ? "No especificado" : titulacion, certificacionIngles, telefono, email);
